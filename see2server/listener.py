...
from agenthelpers import clearAgentTasks, displayResults
from common import *
...
class Listener:
    ...
    def __init__(self, name, port, ipaddress):
        ...
        #responsible for handling new agents
        ...
        def registerAgent():
            ...
            writeToDatabase(agentsDB, Agent(name, self.name, remoteip, hotsname, Type, self.key))
            return (name, 200)
